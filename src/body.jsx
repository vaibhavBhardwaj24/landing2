    ...
    <main>
            ...
            <div class="w-full px-4 lg:w-5/12">
              ...
              >
                <img
                  ...
                  srcset="
                /_next/image?url=%2Fimages%2Fhero%2Fhero-light.png&amp;w=384&amp;q=75 1x,
                /_next/image?url=%2Fimages%2Fhero%2Fhero-light.png&amp;w=750&amp;q=75 2x
              "
                  src="/_next/image?url=%2Fimages%2Fhero%2Fhero-light.png&amp;w=750&amp;q=75"
                />
                <div class="max-auto absolute left-0 right-0 top-0 -z-10 aspect-square w-full rounded-full bg-gradient-1">
      ...
      <section id="features" class="relative z-10 pt-[110px]">
        ...
        <div class="container max-w-[1390px]">
          <div class="rounded-2xl bg-white px-5 pb-14 pt-14 shadow-card dark:bg-dark dark:shadow-card-dark md:pb-1 lg:pb-5 lg:pt-20 xl:px-10">
        ...
        <div class="absolute -bottom-1/2 left-0 -z-10 hidden md:block">
          <svg
            width="622"
            height="1236"
              ...
              <div class="w-full px-4 lg:w-1/2">
                ...
                >
                  <img
                    ...
                    // // style="color: transparent"
                    srcset="
                  /_next/image?url=%2Fimages%2Fabout%2Fabout-1-light.png&amp;w=384&amp;q=75 1x,
                  /_next/image?url=%2Fimages%2Fabout%2Fabout-1-light.png&amp;w=640&amp;q=75 2x
                "
                    src="/_next/image?url=%2Fimages%2Fabout%2Fabout-1-light.png&amp;w=640&amp;q=75"
                  />
                  <div class="absolute right-5 top-0 -z-10">
                    <svg
                      width="72"
                      height="50"
                      viewBox="0 0 72 50"
                  ...
                  <div class="absolute bottom-0 left-0 -z-10 h-1/2 w-full rounded-[20px] bg-gradient-1">
                    <div class="absolute -top-12 left-10 -z-10">
                      <svg
                        width="65"
                        height="36"
                        viewBox="0 0 65 36"
                    ...
                    <div class="absolute left-0 top-0 h-full w-full bg-texture"></div>
                  </div>
                </div>
              </div>
              <div class="w-full px-4 lg:w-1/2">
                ...
                >
                  ...
                  <div class="mb-[30px] flex items-center">
                    <div class="mr-[22px] flex h-[60px] w-[60px] items-center justify-center rounded-full border border-stroke text-xl font-semibold text-black dark:border-stroke-dark dark:bg-dark dark:text-white">
                      01
                    </div>
                    <div>
            ...
            <div class="-mx-4 flex flex-wrap items-center justify-between">
              <div class="w-full px-4 lg:w-1/2">
                <div class="wow fadeInUp lg:max-w-[510px]" data-wow-delay=".2s">
                  ...
                  <a
                    class="inline-block rounded-md bg-primary px-8 py-[10px] text-base font-medium text-white hover:bg-opacity-90"
                    href="#"
                  >
                    Know More
                  </a>
              ...
              <div class="order-first w-full px-4 lg:order-last lg:w-1/2">
                <div
                  class="wow fadeInUp relative z-10 mx-auto mb-14 w-full max-w-[470px] pb-6 lg:mb-0 lg:mr-0"
                  data-wow-delay=".3s"
                >
                  <img
                    alt="about image"
                    ...
                    // // style="color: transparent"
                    srcset="
                  /_next/image?url=%2Fimages%2Fabout%2Fabout-2-light.png&amp;w=384&amp;q=75 1x,
                  /_next/image?url=%2Fimages%2Fabout%2Fabout-2-light.png&amp;w=640&amp;q=75 2x
                "
                    src="/_next/image?url=%2Fimages%2Fabout%2Fabout-2-light.png&amp;w=640&amp;q=75"
                  />
                  <div class="absolute right-5 top-0 -z-10">
                    <svg
                      width="72"
        ...
        <div class="container max-w-[1120px] overflow-hidden">
          ...
          >
            <label for="togglePlan" class="inline-flex items-center">
              ...
              <span class="mx-5 flex h-[34px] w-[60px] cursor-pointer items-center rounded-full bg-primary p-[3px]">
                <span class="false block h-7 w-7 rounded-full bg-white duration-300"></span>
              </span>
          ...
          <div class="-mx-6 flex flex-wrap justify-center">
            <div class="w-full px-6 md:w-1/2 lg:w-1/3">
              <div class="wow fadeInUp relative mb-10 rounded-xl bg-white px-9 py-10 shadow-card dark:bg-dark dark:shadow-card-dark lg:mb-4 lg:px-7 xl:px-9">
                ...
                <div class="space-y-4 pb-10 pt-[30px]">
                ...
                <button
                  ...
                  class="block w-full rounded-md px-8 py-[10px] text-center text-base font-medium text-white bg-black hover:bg-primary dark:bg-[#2A2E44] dark:hover:bg-primary"
                >
                  Choose Plan
                </button>
              </div>
            ...
            <div class="w-full px-6 md:w-1/2 lg:w-1/3">
              <div class="wow fadeInUp relative mb-10 rounded-xl bg-white px-9 py-10 shadow-card dark:bg-dark dark:shadow-card-dark lg:mb-4 lg:px-7 xl:px-9">
                <span class="absolute right-5 top-5 text-sm font-medium text-primary underline">
                  Most popular
                </span>
                <h3 class="mb-2 text-[22px] font-semibold leading-tight text-black dark:text-white">
                  Unlimited
                ...
                <p class="border-b border-stroke pb-5 text-black dark:border-stroke-dark dark:text-white">
                  <span class="text-[40px] font-bold leading-none">
                    <sup class="text-[22px] font-medium"> $ </sup>35
                  </span>
                  <span class="text-base text-body"> / month </span>
                </p>
                <div class="space-y-4 pb-10 pt-[30px]">
                ...
                <button
                  aria-label="purchase this plan"
                  class="block w-full rounded-md px-8 py-[10px] text-center text-base font-medium text-white bg-primary hover:bg-opacity-90"
                >
                  Choose Plan
                </button>
              </div>
            ...
            <div class="w-full px-6 md:w-1/2 lg:w-1/3">
              <div class="wow fadeInUp relative mb-10 rounded-xl bg-white px-9 py-10 shadow-card dark:bg-dark dark:shadow-card-dark lg:mb-4 lg:px-7 xl:px-9">
                ...
                <p class="border-b border-stroke pb-5 text-black dark:border-stroke-dark dark:text-white">
                  <span class="text-[40px] font-bold leading-none">
                    <sup class="text-[22px] font-medium"> $ </sup>59
                  </span>
                  <span class="text-base text-body"> / month </span>
                </p>
                <div class="space-y-4 pb-10 pt-[30px]">
      ...
      <section id="screens" class="relative z-20 pt-[110px]">
        ...
        <div class="container">
          <div class="wow fadeInUp mx-auto max-w-[1000px]" data-wow-delay=".2s">
            <div class="swiper swiper-initialized swiper-horizontal mySwiper relative z-20 swiper-backface-hidden">
              <div class="swiper-wrapper">
                <div
                  class="swiper-slide swiper-slide-active"
                  // // style="width: 282.667px; margin-right: 40px"
                ...
                >
                  <div class="mx-auto w-full max-w-[252px] xs:max-w-[265px]">
                    <img
                      ...
                      // // style="color: transparent"
                      srcset="
                    /_next/image?url=%2Fimages%2Fscreens%2Fscreen-1-light.png&amp;w=384&amp;q=75 1x,
                    /_next/image?url=%2Fimages%2Fscreens%2Fscreen-1-light.png&amp;w=640&amp;q=75 2x
                  "
                      src="/_next/image?url=%2Fimages%2Fscreens%2Fscreen-1-light.png&amp;w=640&amp;q=75"
                    />
                  </div>
                </div>
                <div
                ...
                >
                  <div class="mx-auto w-full max-w-[252px] xs:max-w-[265px]">
                    <img
                      ...
                      // // style="color: transparent"
                      srcset="
                    /_next/image?url=%2Fimages%2Fscreens%2Fscreen-2-light.png&amp;w=384&amp;q=75 1x,
                    /_next/image?url=%2Fimages%2Fscreens%2Fscreen-2-light.png&amp;w=640&amp;q=75 2x
                  "
                      src="/_next/image?url=%2Fimages%2Fscreens%2Fscreen-2-light.png&amp;w=640&amp;q=75"
                    />
                  </div>
                </div>
                <div
                ...
                >
                  <div class="mx-auto w-full max-w-[252px] xs:max-w-[265px]">
                    <img
                      ...
                      // // style="color: transparent"
                      srcset="
                    /_next/image?url=%2Fimages%2Fscreens%2Fscreen-3-light.png&amp;w=384&amp;q=75 1x,
                    /_next/image?url=%2Fimages%2Fscreens%2Fscreen-3-light.png&amp;w=640&amp;q=75 2x
                  "
                      src="/_next/image?url=%2Fimages%2Fscreens%2Fscreen-3-light.png&amp;w=640&amp;q=75"
                    />
                  </div>
                </div>
                <div
              ...
              <div class="absolute left-0 right-0 top-0 z-50 mx-auto w-full md:w-1/3">
                <img
                  alt="mobile-frame"
                  loading="lazy"
                  width="288"
                  ...
                  // // style="color: transparent"
                  srcset="
                /_next/image?url=%2Fimages%2Fscreens%2Fmobile-frame.png&amp;w=384&amp;q=75 1x,
                /_next/image?url=%2Fimages%2Fscreens%2Fmobile-frame.png&amp;w=640&amp;q=75 2x
              "
                  src="/_next/image?url=%2Fimages%2Fscreens%2Fmobile-frame.png&amp;w=640&amp;q=75"
                />
              </div>
      ...
      <section id="cta" class="relative z-10 pt-[110px]">
              ...
              <div class="w-full px-4 lg:w-1/2">
                ...
                >
                  <img
                    ...
                    // // style="color: transparent"
                    srcset="
                  /_next/image?url=%2Fimages%2Fcta%2Fcta-light.png&amp;w=384&amp;q=75 1x,
                  /_next/image?url=%2Fimages%2Fcta%2Fcta-light.png&amp;w=640&amp;q=75 2x
                "
                    src="/_next/image?url=%2Fimages%2Fcta%2Fcta-light.png&amp;w=640&amp;q=75"
                  />
        ...
        <div class="absolute -top-[250px] right-0 -z-10">
          <svg
            width="610"
            height="1183"
      ...
      <section id="testimonials" class="relative z-10 pb-[60px] pt-[110px]">
        <div class="container">
          <div
            class="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]"
            data-wow-delay=".2s"
        ...
        <div class="container overflow-hidden lg:max-w-[1160px]">
          <div class="-mx-6 flex flex-wrap">
            <div class="w-full px-6 lg:w-1/2">
              <div
                class="wow fadeInUp mb-[50px] rounded-lg bg-white px-7 py-9 shadow-card dark:bg-dark dark:shadow-card-dark sm:px-9 lg:px-7 xl:px-9"
                data-wow-delay=".2s"
              >
                  ...
                  <div class="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0">
                    <div class="mr-4 h-[56px] w-full max-w-[56px] rounded-full">
                      <img
                        ...
                        // // style="color: transparent"
                        srcset="
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-1.png&amp;w=64&amp;q=75  1x,
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-1.png&amp;w=128&amp;q=75 2x
                    "
                        src="/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-1.png&amp;w=128&amp;q=75"
                      />
                    </div>
                    <div>
                  ...
                  <div class="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0">
                    <div class="mr-4 h-[56px] w-full max-w-[56px] rounded-full">
                      <img
                        ...
                        // // style="color: transparent"
                        srcset="
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-2.png&amp;w=64&amp;q=75  1x,
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-2.png&amp;w=128&amp;q=75 2x
                    "
                        src="/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-2.png&amp;w=128&amp;q=75"
                      />
                    </div>
                    <div>
                      <h5 class="text-base font-medium text-black dark:text-white">
                  ...
                  <div class="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0">
                    <div class="mr-4 h-[56px] w-full max-w-[56px] rounded-full">
                      <img
                        ...
                        // // style="color: transparent"
                        srcset="
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-3.png&amp;w=64&amp;q=75  1x,
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-3.png&amp;w=128&amp;q=75 2x
                    "
                        src="/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-3.png&amp;w=128&amp;q=75"
                      />
                    </div>
                    <div>
                      <h5 class="text-base font-medium text-black dark:text-white">
                  ...
                  <div class="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0">
                    <div class="mr-4 h-[56px] w-full max-w-[56px] rounded-full">
                      <img
                        ...
                        // // style="color: transparent"
                        srcset="
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-04.png&amp;w=64&amp;q=75  1x,
                      /_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-04.png&amp;w=128&amp;q=75 2x
                    "
                        src="/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-04.png&amp;w=128&amp;q=75"
                      />
                    </div>
                    <div>
                      <h5 class="text-base font-medium text-black dark:text-white">
      ...
      >
        <div class="container">
          ...
          >
            <div class="faq border-b border-stroke last-of-type:border-none dark:border-stroke-dark">
              <button class="faq-btn relative flex w-full items-center justify-between px-[18px] py-6 text-left text-base font-medium text-black dark:text-white sm:px-[26px] sm:text-lg">
              ...
              <div class="faq-content h-auto overflow-hidden border-t border-stroke px-[18px] dark:border-stroke-dark sm:px-[26px] max-h-0 py-0 opacity-0 transition-all duration-100 ease-in-out">
                <p class="text-base text-body">
        ...
        <div class="absolute -bottom-24 left-0 -z-10">
          <svg
            width="95"
            height="190"
            viewBox="0 0 95 190"
      ...
      <section class="pb-[60px] pt-[110px]" id="blog">
        <div class="container">
          <div
            class="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]"
            data-wow-delay=".2s"
        ...
        <div class="container overflow-hidden lg:max-w-[1250px]">
          <div class="-mx-4 flex flex-wrap justify-center md:-mx-7 lg:-mx-5 xl:-mx-[35px]">
            <article class="w-full px-4 md:w-1/2 md:px-7 lg:w-1/3 lg:px-5 xl:px-[35px]">
              <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
                <div class="relative h-[200px] overflow-hidden rounded xl:h-[240px]">
                  <a
                    class="block overflow-hidden"
                    href="/blog/50-high-rated-online-banking-mobile-apps-on-playstore"
                  >
                    <img
                      alt="blog"
                      loading="lazy"
                      ...
                      sizes="100vw"
                      srcset="
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=640&amp;q=100   640w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=750&amp;q=100   750w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=828&amp;q=100   828w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=1080&amp;q=100 1080w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=1200&amp;q=100 1200w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=1920&amp;q=100 1920w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=2048&amp;q=100 2048w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=3840&amp;q=100 3840w
                  "
                      src="/_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2F82104b73a950d9dc652aedf836f02b17cc18b499-970x430.jpg&amp;w=3840&amp;q=100"
                    />
                  </a>
                  <div class="absolute left-0 top-0 flex h-full w-full items-end bg-gradient-3 px-[18px] py-4">
                    <div class="-mx-[10px] flex flex-wrap">
                      <a
                        class="mt-3 flex items-center px-[10px] text-base font-medium text-white"
                        href="/blog/author/juhan-ahamed"
                      >
                        <span class="mr-2">
                          <svg
                            width="18"
                ...
                <div class="mt-[30px]">
                  <h3>
                    <a
                      ...
                      href="/blog/50-high-rated-online-banking-mobile-apps-on-playstore"
                    >
                      Laboris nisi aliquip dium exiuliym commo...
                    </a>
                  </h3>
                  <p class="text-base text-body">
                  ...
                  <a
                    class="mt-8 inline-block rounded-md bg-primary px-8 py-[10px] text-base font-medium text-white hover:bg-opacity-90"
                    href="/blog/50-high-rated-online-banking-mobile-apps-on-playstore"
                  >
                    Read More
                  </a>
            ...
            <article class="w-full px-4 md:w-1/2 md:px-7 lg:w-1/3 lg:px-5 xl:px-[35px]">
              <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
                <div class="relative h-[200px] overflow-hidden rounded xl:h-[240px]">
                  <a
                    class="block overflow-hidden"
                    href="/blog/50-high-rated-online-banking-mobile-apps-on-playstoress"
                  >
                    <img
                      alt="blog"
                      loading="lazy"
                      ...
                      sizes="100vw"
                      srcset="
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=640&amp;q=100   640w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=750&amp;q=100   750w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=828&amp;q=100   828w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=1080&amp;q=100 1080w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=1200&amp;q=100 1200w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=1920&amp;q=100 1920w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=2048&amp;q=100 2048w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=3840&amp;q=100 3840w
                  "
                      src="/_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fdbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg&amp;w=3840&amp;q=100"
                    />
                  </a>
                  <div class="absolute left-0 top-0 flex h-full w-full items-end bg-gradient-3 px-[18px] py-4">
                    <div class="-mx-[10px] flex flex-wrap">
                ...
                <div class="mt-[30px]">
                  <h3>
                    <a
                      ...
                      href="/blog/50-high-rated-online-banking-mobile-apps-on-playstoress"
                    >
                      Quis nostrud exercitati ullamc laboris n...
                    </a>
                  </h3>
                  <p class="text-base text-body">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nun
            ...
            <article class="w-full px-4 md:w-1/2 md:px-7 lg:w-1/3 lg:px-5 xl:px-[35px]">
              <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
                <div class="relative h-[200px] overflow-hidden rounded xl:h-[240px]">
                  <a
                    class="block overflow-hidden"
                    href="/blog/50-high-rated-online-banking-mobile-apps-on-playstores"
                  >
                    <img
                      alt="blog"
                      loading="lazy"
                      ...
                      sizes="100vw"
                      srcset="
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=640&amp;q=100   640w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=750&amp;q=100   750w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=828&amp;q=100   828w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=1080&amp;q=100 1080w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=1200&amp;q=100 1200w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=1920&amp;q=100 1920w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=2048&amp;q=100 2048w,
                    /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=3840&amp;q=100 3840w
                  "
                      src="/_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fdhvoeo1o%2Fproduction%2Fa0ca7f2ce7b15da5c3c4bb79e6856ab013fce446-970x430.jpg&amp;w=3840&amp;q=100"
                    />
                  </a>
                  <div class="absolute left-0 top-0 flex h-full w-full items-end bg-gradient-3 px-[18px] py-4">
                    <div class="-mx-[10px] flex flex-wrap">
                ...
                <div class="mt-[30px]">
                  <h3>
                    <a
                      ...
                      href="/blog/50-high-rated-online-banking-mobile-apps-on-playstores"
                    >
                      Expenses as material bre mate insisted b...
                    </a>
                  </h3>
                  <p class="text-base text-body">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nun
      ...
      <section class="relative z-10 bg-[#F8FAFB] pb-[50px] pt-[70px] dark:bg-[#15182B]">
        <div
      ...
      <section id="support" class="pb-[110px] pt-[100px]">
        <div class="container">
          <div
            class="wow fadeInUp mx-auto mb-10 max-w-[690px] text-center"
            data-wow-delay=".2s"
              ...
              <div class="-mx-[22px] flex flex-wrap">
                <div class="w-full px-[22px] md:w-1/2">
                  <div class="mb-8">
                    <input
                      ...
                      class="w-full rounded border border-stroke bg-white px-[30px] py-4 text-base text-body outline-none focus:border-primary dark:border-[#34374A] dark:bg-[#2A2E44] dark:focus:border-primary"
                      type="text"
                      name="name"
                    />
                  </div>
                ...
                <div class="w-full px-[22px]">
                  <div class="text-center">
                    ...
                    <button
                      type="submit"
                      class="inline-block rounded-md bg-primary px-11 py-[14px] text-base font-medium text-white hover:bg-opacity-90"
                    >
                      Contact Us
                    </button>
                  </div>
