  ...
  return (
    <div className="w-full h-full flex justify-center items-center flex-col">
      ...
      <main className="w-full flex justify-center flex-col items-center">
        <section
          id="home"
          className="pt-[165px] w-full flex justify-center items-center"
        >
              ...
              <div className="w-full px-4 lg:w-7/12">
                ...
                >
                  ...
                  <h1 className="mb-6 text-3xl font-bold leading-tight text-black dark:text-white sm:text-[40px] md:text-[50px] lg:text-[42px] xl:text-[50px]">
                    Next.js Template and SaaS Starter Kit Site.
                  ...
                  <div className="flex flex-wrap items-center">
                    ...
                    >
                      ...
                      <span className="text-base font-medium">
                        <span className="block text-sm"> Watch Demo </span>See
                        how it works
                      </span>
                    </a>
                  </div>
              ...
              <div className="w-full px-4 lg:w-5/12">
                ...
                >
                  <img
                    ...
                    decoding="async"
                    data-nimg="1"
                    className="bg-transparent mx-auto max-w-full"
                    // // style="color: transparent"

                    src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fhero%2Fhero-light.png&w=750&q=75"
                  />
        ...
        <section
          id="features"
          className="relative w-full flex flex-col justify-center items-center z-10 pt-[110px]"
        >
        ...
        <section
          id="about"
          className="relative w-full flex flex-col justify-center items-center pt-[150px]"
        >
                ...
                <div className="w-full px-4 lg:w-1/2">
                  ...
                  >
                    <img
                      ...
                      src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fabout%2Fabout-1-light.png&w=640&q=75"
                    />
                ...
                <div className="order-first w-full px-4 lg:order-last lg:w-1/2">
                  ...
                  >
                    <img
                      ...
                      data-nimg="1"
                      className="mx-auto max-w-full"
                      src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fabout%2Fabout-2-light.png&w=640&q=75"
                    />
                    <div className="absolute right-5 top-0 -z-10">
                      <svg
                        width="72"
        ...
        {/* <section
          id="screens"
          className="relative w-full flex flex-col justify-center items-center z-20 pt-[110px]"
        >
          <div className="container">
            <div
            ...
            >
              <div className="swiper swiper-initialized swiper-horizontal mySwiper relative z-20 swiper-backface-hidden">
                <div className="swiper-wrapper">
                  <div
                    className="swiper-slide w-[282.667px] mr-10 swiper-slide-active"
                    // // style="width: ; margin-right: 40px"
                  ...
                  >
                    <div className="mx-auto w-full max-w-[252px] xs:max-w-[265px]">
                      <img
                        ...
                        src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fscreens%2Fscreen-3-light.png&w=640&q=75"
                      />
                    </div>
                  </div>
                  <div
                    className="swiper-slide swiper-slide-next w-[282.667px] mr-10"
                  ...
                  >
                    <div className="mx-auto w-full max-w-[252px] xs:max-w-[265px]">
                      <img
                        ...
                        data-nimg="1"
                        className="mx-auto w-full rounded-2xl"
                        src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fscreens%2Fscreen-2-light.png&w=640&q=75"
                      />
                    </div>
                  </div>
                  <div
                  ...
                  "
                        src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fscreens%2Fscreen-1-light.png&w=640&q=75"
                      />
                    </div>
                  </div>
                  <div
                ...
                <div className="absolute left-0 right-0 top-0 z-50 mx-auto w-full md:w-1/3">
                  <img
                    ...
                    data-nimg="1"
                    className="mx-auto max-w-full"
                    src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fscreens%2Fmobile-frame.png&w=640&q=75"
                  />
                </div>
        ...
        <section
          id="cta"
          className="relative w-full z-10 flex flex-col justify-center items-center pt-[110px]"
        >
          <div className="container max-w-[1390px]">
                ...
                <div className="w-full px-4 lg:w-1/2">
                  ...
                  >
                    <img
                      ...
                      data-nimg="1"
                      className="mx-auto max-w-full"
                      src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fcta%2Fcta-light.png&w=640&q=75"
                    />
        ...
        <section
          id="testimonials"
          className="relative z-10 flex flex-col justify-center items-center pb-[60px] pt-[110px]"
        >
          <div className="container">
            <div
              className="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]"
                    ...
                    <div className="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0">
                      <div className="mr-4 h-[56px] w-full max-w-[56px] rounded-full">
                        <img
                          ...
                          src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-1.png&w=128&q=75"
                        />
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-body">Web Entrepreneur</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0">
                      <div className="mr-4 h-[56px] w-full max-w-[56px] rounded-full">
                        <img
                          ...
                          data-nimg="1"
                          className="h-full w-full object-cover object-center"
                          src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-2.png&w=128&q=75"
                        />
                      </div>
                      <div>
                        <h5 className="text-base font-medium text-black dark:text-white">
                    ...
                    <div className="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0">
                      <div className="mr-4 h-[56px] w-full max-w-[56px] rounded-full">
                        <img
                          ...
                          data-nimg="1"
                          className="h-full w-full object-cover object-center"
                          src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-3.png&w=128&q=75"
                        />
                      </div>
                      <div>
                        <h5 className="text-base font-medium text-black dark:text-white">
              ...
              <div className="w-full px-6 lg:w-1/2">
                ...
                >
                  ...
                  <div className="items-center justify-between sm:flex lg:block xl:flex">
                    ...
                    "
                          src="https://appline.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Ftestimonials%2Fauthor-04.png&w=128&q=75"
                        />
                      </div>
                      <div>
                        <h5 className="text-base font-medium text-black dark:text-white">
        ...
        <section
          id="faq"
          className="relative z-10 w-full flex justify-center items-center bg-[#F8FAFB] py-[110px] dark:bg-[#15182B]"
        >
          <div className="container">
            <div
              className="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]"
            ...
            >
              <div className="faq border-b border-stroke last-of-type:border-none dark:border-stroke-dark">
                <button className="faq-btn relative flex w-full items-center justify-between px-[18px] py-6 text-left text-base font-medium text-black dark:text-white sm:px-[26px] sm:text-lg">
                ...
                <div className="faq-content h-auto overflow-hidden border-t border-stroke px-[18px] dark:border-stroke-dark sm:px-[26px] max-h-0 py-0 opacity-0 transition-all duration-100 ease-in-out">
                  <p className="text-base text-body">
        ...
        <section className="relative z-10  w-fullflex justify-center items-center bg-[#F8FAFB] pb-[50px] pt-[70px] dark:bg-[#15182B]">
          <div
                ...
                <div className="mb-5 text-center">
                  <a className="block" href="#">
                    <img
                      ...
                      // style="color: transparent"
                      src="https://appline.demo.nextjstemplates.com/images/clients/client-01.svg"
                    />
                  </a>
                </div>
              </div>
                ...
                <div className="mb-5 text-center">
                  <a className="block" href="#">
                    <img
                      ...
                      className="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                      // style="color: transparent"
                      src="https://appline.demo.nextjstemplates.com/images/clients/client-02.svg"
                    />
                  </a>
                </div>
              </div>
                ...
                <div className="mb-5 text-center">
                  <a className="block" href="#">
                    <img
                      ...
                      className="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                      // style="color: transparent"
                      src="https://appline.demo.nextjstemplates.com/images/clients/client-03.svg"
                    />
                  </a>
                </div>
              </div>
                ...
                <div className="mb-5 text-center">
                  <a className="block" href="#">
                    <img
                      ...
                      className="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                      // style="color: transparent"
                      src="https://appline.demo.nextjstemplates.com/images/clients/client-04.svg"
                    />
                  </a>
                </div>
              </div>
                ...
                <div className="mb-5 text-center">
                  <a className="block" href="#">
                    <img
                      ...
                      className="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                      // style="color: transparent"
                      src="https://appline.demo.nextjstemplates.com/images/clients/client-05.svg"
                    />
                  </a>
                </div>
              </div>
                ...
                <div className="mb-5 text-center">
                  <a className="block" href="#">
                    <img
                      ...
                      className="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                      // style="color: transparent"
                      src="https://appline.demo.nextjstemplates.com/images/clients/client-06.svg"
                    />
                  </a>
                </div>
              </div>
